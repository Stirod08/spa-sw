            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <nav className="flex flex-col space-y-1">
                        <Link href={"enDesarrollo"} className="text-sm hover:text-orange">Masajes terapéuticos</Link>
                        <Link href={"enDesarrollo"} className="text-sm hover:text-orange">Limpiezas faciales profundas</Link>
                        <Link href={"enDesarrollo"} className="text-sm hover:text-orange">Spa de manos y pies</Link>
                        <Link href={"enDesarrollo"} className="text-sm hover:text-orange">Rituales corporales detox</Link>
                    </nav>
                </div>
