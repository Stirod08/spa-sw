...
export default function Hero() {
  return (
    <>
      <div className="h-dvh lg:h-[500px]  mask-b-from-50% mask-b-to-90% bg-[url('/about.jpg')] bg-no-repeat bg-cover "></div>
      <section className="-mt-40 lg:w-[70%] mx-auto p-4 bg-blanco relative z-10 rounded-md  hyphens-auto text-justify">
