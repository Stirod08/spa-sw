  ...
  return (
    <>
      <section className="my-8">
        <h2 className="text-2xl font-bold mb-2 uppercase text-verdeOscuro text-center">
          Servicios
        </h2>
        <p className="md:max-w-3xl mx-auto text-center">
          Explora los rituales diseñados para renovar tu cuerpo y reconectar con tu energía. Cada
          servicio ha sido pensado para darte una experiencia transformadora y profundamente
          relajante.
        </p>
